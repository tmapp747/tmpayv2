  ...
  const renderStatistics = () => {
    ...
    return (
      <div className="space-y-3">
        ...
        {statistics.casinoBetCount !== undefined && (
          <div 
            className="bg-gradient-to-br from-indigo-500 to-purple-700 rounded-xl p-4 shadow-md text-white mt-3"
            onClick={() => toggleSection('games')}
          >
            <div className="flex justify-between items-center">
              <h3 className="font-medium">Game Performance</h3>
              <ChevronDown 
                className={`h-5 w-5 transition-transform ${expandedSection === 'games' ? 'rotate-180' : ''}`}
              />
            </div>
            ...
            <AnimatePresence>
              {expandedSection === 'games' && (
                ...
                >
                  <div className="pt-3">
                    {/* Donut chart representation of game distribution */}
                    <div className="flex justify-center mb-3">
                      <div className="relative w-28 h-28">
                        {/* Slots segment - 65% */}
                        <div className="absolute inset-0 border-8 border-purple-300 rounded-full" 
                             style={{ clipPath: 'polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%, 50% 100%)' }}></div>
                        {/* Casino segment - 25% */}
                        <div className="absolute inset-0 border-8 border-blue-300 rounded-full" 
                             style={{ clipPath: 'polygon(50% 50%, 0% 0%, 50% 0%)' }}></div>
                        {/* Sports segment - 10% */}
                        <div className="absolute inset-0 border-8 border-green-300 rounded-full" 
                             style={{ clipPath: 'polygon(50% 50%, 0% 0%, 0% 50%)' }}></div>
                        {/* Inner circle */}
                        <div className="absolute inset-4 bg-indigo-800 rounded-full flex items-center justify-center">
                          <span className="text-xs text-white font-medium">Game Mix</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      ...
                      <div className="bg-white/10 rounded-lg p-2 text-center">
                        <div className="h-2 w-full bg-green-300 rounded-full mb-1"></div>
                    ...
                    <div className="pt-2 border-t border-white/20">
                      <div className="text-sm font-medium mb-2">Most Played Games</div>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-xs opacity-80">Fortune Tiger</span>
                          <div className="flex items-center">
                            <div className="w-16 bg-white/20 h-1.5 rounded-full overflow-hidden mr-2">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-xs opacity-80">Blackjack</span>
                          <div className="flex items-center">
                            <div className="w-16 bg-white/20 h-1.5 rounded-full overflow-hidden mr-2">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-xs opacity-80">Basketball</span>
                          <div className="flex items-center">
                            <div className="w-16 bg-white/20 h-1.5 rounded-full overflow-hidden mr-2">
                              <div className="bg-white h-full rounded-full" style={{ width: '5%' }}></div>
                            </div>
